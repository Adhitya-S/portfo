      ...
      >
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            Designing the Future with Artificial Intelligence <br className="sm:block hidden" />
            AI-Fueled Solutions. Data-Driven Impact.
          </p>
          ...
          <div className="flex mt-4 gap-4 z-10 relative">
            ...
            <a
              href="https://drive.google.com/file/d/1sewhYJi-GgeU1NiN0LvDp1IU-rF0nbaI/view?usp=share_link"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Resume"
            >
